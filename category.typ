...
范畴论真正成为独立的学科, 是在 Grothendieck 发表于 1957 年的 _Sur quelques points d'algèbre homologique_, 由于其发表的刊物名称, 一般简称作 “Tôhoku 论文”. Grothendieck 公理化地定义了 Abel 范畴等. 这使得同调代数可以在更高的抽象层次上进行. 这也启发了数学家, 可以在其他领域中寻找能够囊括领域基础概念的范畴公理化体系. 同时, 伴随函子等概念在数学中的普遍性逐渐显现出来, 许多领域中的重要定理都可以放在范畴的框架下表述.
